...
// Symbol override: this helper's legacy cfront name includes an extra integer
// parameter in the original ABI and cannot be regenerated by this declaration.
...
// C linkage: this state accessor is called through the original unmangled API.
