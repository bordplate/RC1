...
##### Note on Deadlocked C code

This is just pseudo-code generated by Ghidra. You can not assume it is accurate and we do
not have the original source code for Deadlocked.
